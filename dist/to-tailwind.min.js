...
var stylesMap_1 = stylesMap$3;

var stylesMap$2 = stylesMap_1;
var _const = {
  stylesMap: stylesMap$2
};

var stylesMap$1 = _const.stylesMap;
var shorthandParser = require$$1;
var styleToTailwind$1 = function styleToTailwind(selector, prop, value, specificity, classMetadata) {
  var tailwindExp = '';
  var expOrMap = stylesMap$1[prop];
      ...
      if (expOrMap === 'content') {
        ...
        value.replace(/([a-z]+?)([A-Z]+)?\(([^,]+)(,.+)?\)/, function (_, p) {
          ...
          if (d) {
            p = p.slice(0, -1);
            d = d.toLowerCase();
            tailwindExp += "".concat(p, "-").concat(d, "-[").concat(vx, "]");
          } else {
            tailwindExp += "".concat(p, "-x-[").concat(vx, "] ").concat(p, "-y-[").concat(vx, "]");
          }
        });
      } else {
