...
var require$$0$2 = require('css-shorthand-parser');
...
var parse$1 = function parse(html) {
  ...
  var matched = html.match(regexp$1);
  var nodes = [];
  var parent = ast;
  var _loop = function _loop() {
    ...
    if (!m.startsWith('</')) {
      ...
      // </i> some text...
      var _text = (_m$match = m.match(/<\/[a-z]+>\s*(.+)\s*/)) === null || _m$match === void 0 ? void 0 : _m$match[1];
      if (_text) {
...
var genAttrs = function genAttrs(attrs, keys, tailwindExp) {
  ...
  if (tailwindExp) {
    ...
    if (attrs["class"]) {
      res += "".concat(Object.keys(attrs["class"]).join());
    }
    res += '"';
  }
  return res;
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          // replace base64's ;
          css = css.replace(/url\(['"](.*?)['"]\)/g, function (_, $1) {
            return "url(\"".concat($1.replace(/;/g, 'my-semicolon'), "\")");
          });
...
var fallback$1 = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(rawCss) {
        ...
        case 0:
          ...
          for (selector in rawCss) {
            ...
            for (prop in rules) {
              ...
              cssText += "".concat(prop, ": ").concat(value, ";");
            }
            cssText += '}\r\n';
          }
          _context.next = 4;
          return writeFile$1('./target/index.css', cssText);
        case 4:
        case "end":
          return _context.stop();
      }
...
var shorthandParser = require$$0$2;
var stylesMap = _const.stylesMap;
var rawCssCollector = function rawCssCollector(rawCss, selector, prop, value) {
  rawCss[selector] = rawCss[selector] || {};
  rawCss[selector][prop] = value;
};
var prefixParser = function prefixParser(selector) {
  var prefix = '';
  selector.replace(/:([a-z]+)/, function (_, $1) {
    prefix = "".concat($1, ":");
  });
  return prefix;
};
var styleToTailwind$1 = function styleToTailwind(selector, prop, value, specificity, classMetadata, rawCss) {
  if (stylesMap[prop]) {
    ...
    var prefix = prefixParser(selector);
    if (isStaticValue) {
      var keywordValue = expOrMap[value];
      if (keywordValue) {
        // position: absolute; -> absolute  
        tailwindExp += "".concat(prefix).concat(expOrMap[value], " ");
      } else {
      ...
      if (res) {
        ...
        for (var i = 0, l = props.length; i < l; i++) {
          ...
          if (_value !== 'unset') {
            styleToTailwind(selector, _prop, _value, specificity, classMetadata, rawCss);
          }
        }
      } else {
        if (expOrMap === 'content') {
          ...
          value.replace(/([a-z]+?)([A-Z]+)?\(([^,]+)(,.+)?\)/, function (_, p) {
            var d = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
            var vx = arguments.length > 3 ? arguments[3] : undefined;
            if (d) {
              d = d.toLowerCase();
              tailwindExp += "".concat(prefix).concat(p, "-").concat(d, "-[").concat(vx, "]");
            } else {
              tailwindExp += "".concat(prefix).concat(p, "-x-[").concat(vx, "] ").concat(p, "-y-[").concat(vx, "]");
            }
          });
        } else {
          tailwindExp += "".concat(prefix).concat(expOrMap, "-[").concat(value, "]");
        }
      }
    }
    classMetadata[key] = {
...
var styleToTailwind_1 = styleToTailwind$1;

var regexp = /@media[^\{]+\{([^\{\}]*\{[^\}\{]*\})+[^\}]+\}/g;
var parseMediaQuery$1 = function parseMediaQuery(css) {
  css = css.replace(regexp, function (_, $1) {
    return '';
  });
  return css;
};
var parseMediaQuery_1 = parseMediaQuery$1;

var classMetadataToTailwindExp$1 = function classMetadataToTailwindExp(classMetadata, rawClass) {
  var tailwindExp = rawClass ? "".concat(rawClass, " ") : '';
  for (var key in classMetadata) {
    tailwindExp += "".concat(classMetadata[key].tailwindExp, " ");
  }
  return tailwindExp.slice(0, -1);
};
var classMetadataToTailwindExp_1 = classMetadataToTailwindExp$1;
...
var styleToTailwind = styleToTailwind_1;
var parseMediaQuery = parseMediaQuery_1;
var classMetadataToTailwindExp = classMetadataToTailwindExp_1;
var deepClone = utils.deepClone;
var cssStyleRuleRegexp = /}?(.*?){(.*?)}/g;
var cssToClassMetadata$1 = function cssToClassMetadata(css, sourceNodes) {
  var rawCss = {};
  ...
  css.replace(cssStyleRuleRegexp, function (_, selector, cssText) {
    ...
    if (nodes.length) {
      ...
      cssText.replace(/(.*?):([^;]*);?/g, function (_, prop, value) {
        styleToTailwind(selector, prop, value, specificity, classMetadata, rawCss);
      });
      for (var i = 0, l = nodes.length; i < l; i++) {
  ...
  for (var i = 0, l = sourceNodes.length; i < l; i++) {
    ...
    var classMetadata = node.classMetadata,
      attrs = node.attrs;
    if (classMetadata) {
...
var cssToClassMetadata_1 = cssToClassMetadata$1;

var writeFile = require$$0.promises.writeFile;
var HTML = htmlParser;
var purifier = purifier_1;
var fallback = fallback_1;
var cssToClassMetadata = cssToClassMetadata_1;
...
var importCss = function importCss(ast) {
  ast.children[0].children[0].children.push({
    type: 'tag',
    attrs: {
      rel: 'stylesheet',
...
var toTailwind = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(htmlInput, cssInput, output) {
    var _yield$purifier, html, css, _HTML$parse, ast, sourceNodes, rawCss, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
        ...
        case 2:
          ...
          rawCss = cssToClassMetadata(css, sourceNodes);
          importTailwind(ast);
