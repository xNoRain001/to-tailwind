...
var toTailwind = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(htmlInput, cssInput, output) {
    var css, html, _HTML$parse, ast, sourceNodes, rawCss, i, l, node, classMetadata, res, _rawCss, selector, rules, prop;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          rawCss = {};
          css.replace(cssStyleRuleRegexp, function (cssStyleRule, selector, cssText) {
            // .foo {}
            if (!cssText) {
              return;
            }
        ...
        case 17:
          ...
          for (selector in rawCss) {
            _rawCss += "".concat(selector, " {");
            rules = rawCss[selector];
            for (prop in rules) {
              _rawCss += "".concat(prop, ": ").concat(rules[prop], ";");
            }
            _rawCss += '}\r\n';
          }
